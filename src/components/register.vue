      ...
      <el-card shadow="always">
        ...
        <el-form ref="form" :model="form" label-width="80px" :rules="rules" label-position="left">
          ...
          <el-form-item label="年龄 :" prop="age" align="left">
            <el-input-number v-model="form.age" :min="1" :max="150" label="请输入年龄"></el-input-number>
          </el-form-item>
          ...
          <el-form-item label="地址 :" prop="city">
            <area-cascader :level="1" type="text" placeholder="请选择家庭住址" v-model="form.city" :data="$pcaa" />
          </el-form-item>
          <el-form-item label="电子邮箱 :" prop="email" :rules="[
             { required: true, message: '请输入邮箱地址', trigger: 'blur' },
             { type: 'email', message: '请输入正确的邮箱地址', trigger: ['blur', 'change'] }
          ]">
            <el-autocomplete class="inline-input" v-model="form.email" :fetch-suggestions="querySearch" :trigger-on-focus="false" placeholder="请输入内容" />
          </el-form-item>
          <el-form-item>
            <div align="right"><a href="#">忘记密码</a></div>
            <el-row>
              <el-col :span="3"><el-button type="success" @click="sumbit()">登录</el-button></el-col>
              <el-col :span="3" :offset="16"><el-button type="primary" @click="sumbit()">注册</el-button></el-col>
            </el-row>
          </el-form-item>
        </el-form>
      </el-card>
...
export default {
    ...
    return {
      ...
      rules: {
        uname: [
          ...
          { min: 6, max: 8, message: '用户名长度在 6 到 8 个字符', trigger: 'blur' },
         ],
        password: [
  ...
  methods: {
    sumbit() {
      ...
      this.$notify({
        title: '芜湖',
        message: h('i', { style: 'color: teal' }, '敲你马')
      })
    },
...
.el-form-item.is-required:not(.is-no-asterisk)
.el-form-item__label:before { content: none; }
</style>
